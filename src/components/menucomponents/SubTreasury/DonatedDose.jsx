    ...
    <div className="w-full h-full">
      <div className="w-full h-[12%] space-x-1 flex">
        ...
        <div className="h-full w-[80%] py-1 border border-collapse border-gray-400 border-2px">
          <div className="w-full h-full grid grid-rows-2 grid-cols-6">
            <div className="row-start-1 row-span-1 col-start-1 col-span-2 flex items-center space-x-2">
            ...
            <div className="row-start-2 row-span-1 col-start-1 col-span-2 flex items-center space-x-2">
              <span className="h-full w-[40%]  font-bold flex justify-end items-center">
                หน่วยงานที่เบิก :
              </span>
              <select
            ...
            <div className="row-start-1 row-span-1 col-start-4 col-span-2 flex justify-start items-center space-x-1 px-2">
              <button className="w-36 h-[90%] rounded-sm text-black font-bold bg-white border border-collapse border-black hover:bg-slate-200 active:bg-slate-300 flex items-center justify-center space-x-2">
                <img src={chse} alt={'ค้นหา'} className="w-6 h-6" />
                <span>{'เลือกยา'}</span>
              </button>
              <button className="w-36 h-[90%] rounded-sm text-black font-bold bg-white border border-collapse border-black hover:bg-slate-200 active:bg-slate-300 flex items-center justify-center space-x-2">
            ...
            <div className="row-start-1 col-start-3 col-span-1 flex justify-start items-center space-x-2 px-2 font-bold">
              <span>{'รับยาจาก : '}</span>
              <select
                className="w-[60%] h-[85%] border border-collapse border-gray-400 "
                name="ward"
                id="1"
              >
                <option value="1">บริจาค</option>
                <option value="2">คลังยา</option>
                <option value="3">ยอดยก</option>
                <option value="4">ยายืม</option>
                <option value="5">ห้องผลิต</option>
              </select>
            </div>
            <div className="row-start-2 col-start-3 col-span-1 flex justify-start items-center space-x-2 px-2 font-bold">
